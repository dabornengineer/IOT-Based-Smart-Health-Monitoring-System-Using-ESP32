    ...
    while (1)
    {
        ...
        switch (state)
        {
            case IDLE:
                ...
                g_measuring  = false;
                g_tempReady  = false;  // clear old result while idle
                g_countdown  = 60;
            ...
            case COUNTDOWN:
                ...
                countdownSeconds++;
                g_countdown = 60 - countdownSeconds;  // ← live countdown
            ...
            case RESULT:
            {
                ...
                if (offset == -1)
                {
                    Serial.println("Poor contact. Place hand firmly on sensor.");
                    // Show raw value, flag as not ready
                    g_palmTemp  = tempC;
                    g_coreTemp  = 0.0f;
                    g_tempReady = false;
                }
